...
import { POPOVER_TOOLTIP } from '@salesforce/design-system-react/utilities/constants';
...
import checkProps from '@salesforce/design-system-react/components/tooltip/check-props';
import componentDoc from '@salesforce/design-system-react/components/tooltip/component.json';
	...
	getTooltip() {
		...
		return isOpen ? (
			<>
                ...
                <div onClick={this.handleMouseLeave} style={{
                    position: "fixed",
                    zIndex: "5999",
                    top: "0px",
                    bottom: "0px",
