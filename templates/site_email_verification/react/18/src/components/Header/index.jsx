...
import checkProps from '@salesforce/design-system-react/components/global-header/check-props';
import componentDoc from '@salesforce/design-system-react/components/global-header/component.json';
		...
		return (
			<header className="slds-global-header_container">
				...
				<div className="slds-global-header slds-grid slds-grid_align-spread">
					<div className="slds-global-header__item slds-global-header__item_logo">
						<div
