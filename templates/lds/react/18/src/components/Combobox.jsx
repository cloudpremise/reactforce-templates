...
import InnerInput from '@salesforce/design-system-react/components/input/private/inner-input';
import InputIcon from '@salesforce/design-system-react/components/icon/input-icon';
import Menu from '@salesforce/design-system-react/components/combobox/private/menu';
import Label from '@salesforce/design-system-react/components/forms/private/label';
import Popover from '@salesforce/design-system-react/components/popover';
import SelectedListBox from '@salesforce/design-system-react/components/pill-container/private/selected-listbox';

import FieldLevelHelpTooltip from '@salesforce/design-system-react/components/tooltip/private/field-level-help-tooltip';
import KEYS from '@salesforce/design-system-react/utilities/key-code';
import KeyBuffer from '@salesforce/design-system-react/utilities/key-buffer';
import keyLetterMenuItemSelect from '@salesforce/design-system-react/utilities/key-letter-menu-item-select';
import mapKeyEventCallbacks from '@salesforce/design-system-react/utilities/key-callbacks';
import menuItemSelectScroll from '@salesforce/design-system-react/utilities/menu-item-select-scroll';

import checkProps from '@salesforce/design-system-react/components/combobox/check-props';

import { COMBOBOX } from '@salesforce/design-system-react/utilities/constants';
import componentDoc from '@salesforce/design-system-react/components/combobox/component.json';
import { IconSettingsContext } from '@salesforce/design-system-react/components/icon-settings';
					...
					<InnerInput
						...
						iconRight={
							<InputIcon
                                ...
                                icon={require("@salesforce/design-system-react/icons/utility/search").default}
							/>
						}
						id={this.getId()}
							...
							iconRight={
								props.selection.length ? (
									<InputIcon
										...
										iconPosition="right"
										name="close"
                                        icon={require("@salesforce/design-system-react/icons/utility/close").default}
										onClick={(event) => {
							...
							<InnerInput
								...
								iconRight={
									<InputIcon
										...
										name="down"
										variant="combobox"
                                        icon={require("@salesforce/design-system-react/icons/utility/down").default}
									/>
								}
								id={this.getId()}
								onFocus={this.handleInputFocus}
