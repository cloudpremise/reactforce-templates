...
// ## Children
import CellFixed from '@salesforce/design-system-react/components/data-table/private/cell-fixed';
import Icon from '../Icons/InlineIcon';

// This component's `checkProps` which issues warnings to developers about properties when in development mode (similar to React's built in development tools)
import checkProps from '@salesforce/design-system-react/components/data-table/column-check-props';

import Link from '@salesforce/design-system-react/components/data-table/private/link';
import InteractiveLink from '@salesforce/design-system-react/components/data-table/interactive-link';
...
const DataTableHeaderCell = (props) => {
	...
	const { fixedHeader, isSorted, label, sortable, width, property, canSelectRows } = props;
		...
		if (sortable) {
			...
			return (
				...
				>
					...
					<Icon
						iconClassName="slds-is-sortable__icon"
						category="utility"
				...
				<CellFixed>
                    {
                        canSelectRows ?
                            <InteractiveCheckbox
                                ...
                                id={`${props.id}-SelectAll-fixed-header`}
