...
const DataTableRowActions = (props) => {
    ...
    function handleRowClick(event){
        const dropdownProps = props.dropdown ? props.dropdown.props : {};
        if(dropdownProps.onClick){
            dropdownProps.onClick(event, props.item);
        }
    }
	...
	return (
		...
		>
			...
			<InteractiveDropdown {...dropdownProps} showButtonIcon onClick={(event) => handleRowClick(event)} />
		</td>
	);
};
