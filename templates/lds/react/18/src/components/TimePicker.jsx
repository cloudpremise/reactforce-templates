...
import checkProps from '@salesforce/design-system-react/components/time-picker/check-props';

// ### Dropdown
import InlineIcon from './Icons/InlineIcon';
import MenuDropdown from './MenuDropdown';
import TimepickerDropdownTrigger from '@salesforce/design-system-react/components/time-picker/private/dropdown-trigger';

// ## Constants
import { TIME_PICKER } from '@salesforce/design-system-react/utilities/constants';

import componentDoc from '@salesforce/design-system-react/components/time-picker/component.json';
				...
				<TimepickerDropdownTrigger
					iconRight={(
                        <InlineIcon
                            ...
                            name="clock"
                            size="xx-small"
                            className="slds-icon-text-default slds-input__icon_right"
                            iconClassName="slds-input__icon"
                            justIcon
                        />
                    )}
