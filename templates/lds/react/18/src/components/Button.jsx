...
import ButtonIcon from '@salesforce/design-system-react/components/icon/button-icon';
import checkProps from '@salesforce/design-system-react/components/button/check-props';
import componentDoc from '@salesforce/design-system-react/components/button/component.json';
...
import getFormProps from '@salesforce/design-system-react/utilities/get-form-props';

import { BUTTON } from '@salesforce/design-system-react/utilities/constants';
...
class Button extends React.Component {
    ...
    getIcon(category, name){
        ...
        return require("@salesforce/design-system-react/icons/"+category+"/"+name).default;
    }
	renderIcon = (name) => {
		const iconSize =
		...
		return (
			<ButtonIcon
				...
				size={iconSize}
                icon={this.getIcon((this.props.iconCategory || 'utility'), name)}
			/>
		);
	};
			...
			>
				...
				{this.props.iconVariant === 'more' ? (
					<ButtonIcon
                        ...
                        icon={this.getIcon("utility", "down")}
					/>
				) : null}
