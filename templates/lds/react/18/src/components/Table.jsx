...
const Table = (props) => {
    ...
    function onLeadModal(status = true){
        setState({
            ...state,
            leadModal: status
        })
    ...
    const actions = () => (
        <PageHeaderControl>
            <ButtonGroup id="button-group-page-header-actions">
                <Button label="New Lead" onClick={() => onLeadModal()} />
        ...
        >
            ...
            >
                <DataTableColumn
                    ...
                    sortable
                    sortDirection={state.sortColumnDirection.opportunityName}
                >
                    <CustomDataTableCell />
                </DataTableColumn>
                ...
                <DataTableColumn
                    isSorted={state.sortColumn === 'confidence'}
                    label="Confidence"
                    property="confidence"
                    sortable
                    sortDirection={state.sortColumnDirection.confidence}
                />
...
Table.displayName = 'JoinedWithPageHeaderExample';
