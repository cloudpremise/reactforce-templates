...
import List from '@salesforce/design-system-react/components/utilities/menu-list';
import ListItem from '@salesforce/design-system-react/components/utilities/menu-list/item';
import ListItemLabel from '@salesforce/design-system-react/components/utilities/menu-list/item-label';

// This is the the default Dropdown Trigger, which expects one button as a child.
import DefaultTrigger from './ButtonTrigger';

// This component's `checkProps` which issues warnings to developers about properties
// when in development mode (similar to React's built in development tools)
import checkProps from '@salesforce/design-system-react/components/menu-dropdown/check-props';
import componentDoc from '@salesforce/design-system-react/components/menu-dropdown/component.json';
...
import keyboardNavigate from '@salesforce/design-system-react/utilities/keyboard-navigate';
import KEYS from '@salesforce/design-system-react/utilities/key-code';
import {
	MENU_DROPDOWN,
	MENU_DROPDOWN_TRIGGER,
	LIST,
} from '@salesforce/design-system-react/utilities/constants';
