...
import colors from '@salesforce/design-system-react/utilities/design-tokens/dist/salesforce-skin.common.js';

import checkProps from '@salesforce/design-system-react/components/global-navigation-bar/check-props';
import componentDoc from '@salesforce/design-system-react/components/global-navigation-bar/component.json';
	...
	render() {
		...
		return (
			...
			<li
				...
				style={listItemstyle}
			>
				<a href="/" className="slds-context-bar__label-action" title={label}>
