...
import checkProps from '@salesforce/design-system-react/components/data-table/check-props';
import componentDoc from '@salesforce/design-system-react/components/data-table/component.json';

import {
	canUseDOM,
	canUseEventListeners,
} from '@salesforce/design-system-react/utilities/execution-environment';
import { colorGray5 } from '@salesforce/design-system-react/utilities/design-tokens/dist/palette-colors.common';
import { tableBorderRadius } from '@salesforce/design-system-react/utilities/design-tokens/dist/salesforce-skin.common';
	...
	render() {
		...
		const canSelectRows =
			this.props.selectRows && numNonHeaderRows > 0
				...
				: false;
		const allSelected = numNonHeaderRows === numSelected;
		const indeterminateSelected =
			numNonHeaderRows !== numSelected && numSelected !== 0;
		...
		let component = (
			<React.Fragment>
				...
				{this.getFixedHeader() && this.props.hasMore && this.props.loading && (
